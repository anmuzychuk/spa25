# Self-Picked Assigment

This folder defines all source code for the 'Self-Picked Assigment' pipeline:
...
* Take a look at the sample under "sample_users_self_picked_assigment.py" to get familiar with the syntax.
